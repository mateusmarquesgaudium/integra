...
class GoingToOrigin extends EventsIfoodManager
{
    ...
    {
        $keyEventRateLimit = str_replace('{event_type}', 'goingToOrigin', RedisSchema::KEY_RATE_LIMIT_ORDERS_EVENTS);
        $maxRequests = 3000;
        ...
        $request = new Request("{$this->customIfood['uri']}/logistics/v1.0/orders/{$event['orderId']}/goingToOrigin");
        $response = $request
            ->setHeaders([
                'Content-Length: 0',
