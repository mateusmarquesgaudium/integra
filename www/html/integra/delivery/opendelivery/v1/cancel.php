...
use src\Opendelivery\Handlers\CancelHandler;
...
try {
    ...
    $cancelHandler = new CancelHandler($custom, $redisClient, $authenticateHandler->getProvider());
    $cancelHandler->orderCancel();

    Util::sendJson(['additionalCharges' => false]);
