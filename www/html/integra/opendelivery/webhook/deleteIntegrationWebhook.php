...
try {
    ...
    $validator = new RequestValidator(['merchant_id', 'provider'], 'DELETE', RequestConstants::CURLOPT_POST_JSON_ENCODE);
    ...
    $redisClient->sRem($keyCacheCredential, $requestData['merchant_id']);
